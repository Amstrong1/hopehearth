<div x-data="{ openMenu: false }" :class="openMenu ? 'overflow-hidden' : 'overflow-visible'">
    ...
    <div>
        <!-- Mobile Menu Toggle -->
        <button class="flex md:hidden align-middle p-4" @click="openMenu = !openMenu">
                        ...
                        <div class="flex flex-wrap">
                            <div class="w-6/12">
                                <a class="text-2xl grid grid-cols-2 font-bold leading-none" href="{{ route('welcome') }}">
                                    <svg class="w-10 h-10" alt="logo" viewBox="0 0 10240 10240">
                    ...
                    <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                        ...
                        <form method="POST" id="logout-form" action="{{ route('logout') }}">
                            ...
                            <span onclick="document.getElementById('logout-form').submit()">
                                <li
                                    class="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase p-4 rounded outline-none focus:outline-none mt-4 ease-linear transition-all duration-150">
                                    Déconnexion
                                    <i class="fas fa-sign-out-alt ml-4 text-sm opacity-75"></i>
                                </li>
                            </span>
                        </form>
                    </ul>
    ...
    <nav class="fixed top-0 right-0 bottom-0 left-0 backdrop-blur-sm z-10" :class="openMenu ? 'visible' : 'invisible'"
        ...
        <ul class="absolute top-0 right-0 bottom-0 w-10/12 p-4 bg-white drop-shadow-2xl z-10 transition-all md:flex-col md:min-w-full flex flex-col list-none"
            ...
            <li class="items-center">
                <a href="{{ route('dashboard') }}" class="text-xs uppercase py-3 font-bold block hover:text-pink-600">
