            ...
            <div class="container mx-auto px-4">
                        ...
                        <a href="{{ route('partner.create') }}">
                            <div
                                ...
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <button type="button"
                                        class="bg-sky-400 text-white text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">
                                        Voir Plus
                                    </button>
                                </div>
                            </div>
                ...
                <div class="flex flex-wrap items-center mt-32">
                    ...
                    <div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
                        <div
                            class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-slate-800">
                            <img alt="..." src="{{ asset('assets/img/team.jpeg') }}"
                                class="w-full align-middle rounded-t-lg" />
                            <blockquote class="relative p-8 mb-4">
                                <svg preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 583 95"
                                    class="absolute left-0 w-full block h-95-px -top-94-px">
                                    <polygon points="-30,95 583,95 583,65" class="text-slate-800 fill-current">
                                    </polygon>
                                </svg>
                ...
                <div class="items-center flex flex-wrap">
                    ...
                    <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
                        <div class="">
                            ...
                            <div class="mt-4 text-lg leading-relaxed text-slate-500">
                                <a href="{{ route('request.create') }}">
                                    <button
                                        class="bg-slate-800 mt-2 text-white active:bg-slate-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">
                                        Faire une demande
                                    </button>
                                </a>
                                ...
                                <div class="flex-auto p-5 lg:p-10">
                                    ...
                                    <div class="relative w-full mb-3 mt-8">
                                        <label class="block uppercase text-slate-600 text-xs font-bold mb-2"
                                            for="full-name">Nom et prénom</label><input name="name" type="text"
                                    ...
                                    <div class="relative w-full mb-3">
                                        <label class="block uppercase text-slate-600 text-xs font-bold mb-2"
                                            for="tel">Contact</label><input type="tel" name="tel"
                                            class="border-0 px-3 py-3 placeholder-slate-300 text-slate-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                            placeholder="Tel" />
                                    </div>
                                    <div class="relative w-full mb-3">
                                        <label class="block uppercase text-slate-600 text-xs font-bold mb-2"
                                            for="Objet">Objet</label><input type="text" name="subject"
                                            class="border-0 px-3 py-3 placeholder-slate-300 text-slate-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                            placeholder="Objet" />
                                    </div>
                                    <div class="relative w-full mb-3">
                                        ...
                                        <textarea rows="4" cols="80"
                                            class="border-0 px-3 py-3 placeholder-slate-300 text-slate-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full" name="message"
                ...
                <div class="w-full lg:w-3/12 px-4">
                    <div class="flex flex-wrap items-top mb-6">
                        <div class="w-full px-4 ml-auto">
                            <span class="block uppercase text-slate-500 text-sm font-semibold mb-2">Contact
                            </span>
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <a class="text-slate-600 hover:text-slate-800 font-semibold block pb-2 text-sm"
                                        href="{{ route('cgu') }}"><i class="fas fa-file-contract"></i> &nbsp
